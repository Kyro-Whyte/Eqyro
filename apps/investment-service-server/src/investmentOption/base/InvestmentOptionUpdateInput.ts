...
@InputType()
class InvestmentOptionUpdateInput {
  @ApiProperty({
    required: false,
    type: Number,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => PaymentUpdateManyWithoutInvestmentOptionsInput,
  })
  @ValidateNested()
  @Type(() => PaymentUpdateManyWithoutInvestmentOptionsInput)
  @IsOptional()
  @Field(() => PaymentUpdateManyWithoutInvestmentOptionsInput, {
    nullable: true,
  })
  payments?: PaymentUpdateManyWithoutInvestmentOptionsInput;
}

export { InvestmentOptionUpdateInput as InvestmentOptionUpdateInput };
