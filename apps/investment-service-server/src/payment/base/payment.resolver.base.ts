...
import { InvestmentOption } from "../../investmentOption/base/InvestmentOption";
...
export class PaymentResolverBase {
  ...
  async createPayment(
    ...
    return await this.service.createPayment({
      ...
      data: {
        ...
        investmentOption: args.data.investmentOption
          ? {
              connect: args.data.investmentOption,
            }
          : undefined,
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => InvestmentOption, {
    nullable: true,
  ...
  async getInvestmentOption(
    @graphql.Parent() parent: Payment
  ): Promise<InvestmentOption | null> {
    const result = await this.service.getInvestmentOption(parent.id);
